...
def get_token():
    try:
        ...
        print(e)
        raise Exception("et_token failed :{}".format(e))
...
url_servers = "https://cph.ap-southeast-1.myhuaweicloud.com/v1/0a7472a0be80250b2f22c001a123b171/cloud-phone/servers"
parameter   =  {"offset" :0 ,"limit" :10}
url_phones  = "https://cph.ap-southeast-1.myhuaweicloud.com/v1/0a7472a0be80250b2f22c001a123b171/cloud-phone/phones?offset=0&limit=2"




def bath_reset():
    url = "https://cph.ap-southeast-1.myhuaweicloud.com/v1/0a7472a0be80250b2f22c001a123b171/cloud-phone/phones/batch-reset"
    print("*******************before reset******************************")
    try:
        token = get_token()
        ...
        headers = {"Content-Type": "application/json", "X-Auth-Token": token}
        phone_settings = {"image_id":"20100320201118f111211a20000003ac","phones": reset_phones}
        ...
        job_request_url = "https://cph.ap-southeast-1.myhuaweicloud.com/v1/0a7472a0be80250b2f22c001a123b171/cloud-phone/jobs?request_id="+request_id
...
def get_cloud_phone_property():
    ...
    df = pandas.read_csv("ym-devices-sample.csv",skiprows=index,nrows=1,header=None,names=['device_brand_name','device_type_name','os_ver_name'])
